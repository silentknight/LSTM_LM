...
def get_config():
  ...
  if FLAGS.model == "small":
    ...
    config = TestConfig()
  elif FLAGS.model == "char":
    config = CharConfig()
  elif FLAGS.model == "spk":
    print(FLAGS.model)
    config = SPKConfig()
  else:
...
def main(_):
  ...
  if FLAGS.model == "spk":
    ...
    raw_data = reader.spk_raw_data(FLAGS.data_path)

  print(len(raw_data[0]), len(raw_data[1]), len(raw_data[2]))
